    ...
    <div className="mt-10 space-y-6">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div className="mt-4 grid gap-6 text-sm text-slate-600 md:grid-cols-2">
          <ul className="space-y-2">
            <li><a className="text-[#326354]" href="#laptop-policy">Laptop &amp; Peripheral Policy</a></li>
            <li><a className="text-[#326354]" href="#purpose">1. Purpose</a></li>
            <li><a className="text-[#326354]" href="#scope">2. Scope</a></li>
            <li><a className="text-[#326354]" href="#ownership-allocation">3. Ownership &amp; Allocation</a></li>
            <li><a className="text-[#326354]" href="#usage-guidelines">4. Usage Guidelines</a></li>
            <li><a className="text-[#326354]" href="#passwords">5. Managing IDs, passwords and protecting information</a></li>
            <li><a className="text-[#326354]" href="#care-maintenance">6. Care &amp; Maintenance</a></li>
            <li><a className="text-[#326354]" href="#it-costs">7. IT Costs and Budgeting</a></li>
            <li><a className="text-[#326354]" href="#security">8. Security &amp; Data Protection</a></li>
            <li><a className="text-[#326354]" href="#best-practices">9. Best Practices for Care</a></li>
            <li><a className="text-[#326354]" href="#return-equipment">10. Return of Equipment</a></li>
            <li><a className="text-[#326354]" href="#compliance">11. Compliance</a></li>
          </ul>
          <ul className="space-y-2">
            <li><a className="text-[#326354]" href="#managers-responsibilities">Managers Responsibilities</a></li>
            <li><a className="text-[#326354]" href="#managers-purpose">1. Purpose</a></li>
            <li><a className="text-[#326354]" href="#managers-scope">2. Scope</a></li>
            <li><a className="text-[#326354]" href="#onboarding">3. Onboarding Responsibilities</a></li>
            <li><a className="text-[#326354]" href="#offboarding">4. Off-boarding Responsibilities</a></li>
            <li><a className="text-[#326354]" href="#team-oversight">5. Team Equipment Oversight</a></li>
            <li><a className="text-[#326354]" href="#laptop-costs">Laptop Costs - per device and Team</a></li>
            <li><a className="text-[#326354]" href="#training-support">6. Training and Support</a></li>
          </ul>
        </div>
      </section>
      ...
      <section className="space-y-6 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div id="laptop-policy" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">Laptop &amp; Peripheral Policy</h2>
          <p className="text-sm text-slate-600">The following Laptop &amp; Peripheral Policy reflects what is feasible for us, as a business. This means will be make decisions on potential hardware changes as and if needed.</p>
          <p className="text-sm text-slate-600">Due to the wear and tear of laptops, keyboards and mice owned by the company that may not be covered by a warranty, we aim to reduce additional costs towards purchases and/or repairs. Leasing is no longer an option.</p>
          <p className="text-sm text-slate-600">If a member of staff or new hire would like a replacement of a laptop or peripheral that is perceived faulty, or is requesting a purchase — the Head of Department should request the item(s) from the Head of Product / IT. This will be reviewed and an appropriate device (laptop, mouse, etc.) will be allocated.</p>
          <p className="text-sm text-slate-600">As further <a className="font-semibold text-[#326354] underline underline-offset-2" href="https://augustcollections.atlassian.net/wiki/spaces/PM/pages/6946817/IT+Policy#3.-Ownership-%26-Allocation" target="_blank" rel="noreferrer">explained below</a>, the requested item may not be the item provided. E.g. not all staff need to use an expensive MacBook when a computer running Windows OS will be satisfactory to perform duties &amp; responsibilities for the staff member.</p>
          <p className="text-sm text-slate-600">Please note that people who are not contractors will not be allowed to use their personal laptops from January 2025 onwards.</p>
          <p className="text-sm text-slate-600">Should a member of staff make a purchase for their own use, this may be considered acceptable — but the member of staff should not assume August will reimburse the individual or department for such purchases.</p>
        </div>

        <div id="purpose" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">1. Purpose</h2>
          <p className="text-sm text-slate-600">This policy outlines the standards, responsibilities, and procedures for the allocation, use, and care of company-issued laptops, and peripherals. The aim is to ensure that all employees have the tools they need to perform their roles effectively, while also protecting August from unnecessary costs and risks associated with equipment misuse or damage. And a clear understanding of their responsibilities for appropriate use of August&apos;s information technology resources.</p>
        </div>

        <div id="scope" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">2. Scope</h2>
          <p className="text-sm text-slate-600">This policy applies to all August employees, contractors, and temporary staff, including interns who are issued equipment (hardware, software, information systems - e.g. Google Drive, channels of communication, including voice- telephony, social media, video, email, instant messaging) by August for work-related purposes.</p>
        </div>

        <div id="ownership-allocation" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">3. Ownership &amp; Allocation</h2>
        ...
        <div id="usage-guidelines" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">4. Usage Guidelines</h2>
          <ul className="list-disc space-y-2 pl-5 text-sm text-slate-600">
        ...
        <div id="passwords" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">5. Managing IDs, passwords and protecting information</h2>
        ...
        <div id="care-maintenance" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">6. Care &amp; Maintenance</h2>
          <ul className="list-disc space-y-2 pl-5 text-sm text-slate-600">
        ...
        <div id="it-costs" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">7. IT Costs and Budgeting</h2>
          <ul className="list-disc space-y-2 pl-5 text-sm text-slate-600">
        ...
        <div id="security" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">8. Security &amp; Data Protection</h2>
          <ul className="list-disc space-y-2 pl-5 text-sm text-slate-600">
        ...
        <div id="best-practices" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">9. Best Practices for Care</h2>
          <p className="text-sm text-slate-600">To reduce the risk of damage and ensure optimal performance:</p>
          <ul className="list-disc space-y-2 pl-5 text-sm text-slate-600">
          ...
          <p className="text-sm text-slate-600">Many issues that interfere with the performance of your laptop may be resolved by simply restarting the device regularly.</p>
        </div>

        <div id="return-equipment" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">10. Return of Equipment</h2>
          <p className="text-sm text-slate-600">Upon termination of employment or completion of contract, employees must return their laptop and all associated accessories in good condition.</p>
          <p className="text-sm text-slate-600">Failure to return equipment may result in the cost being deducted from final pay.</p>
        </div>
        ...
        <div id="managers-responsibilities" className="space-y-3 pt-2">
          <h2 className="text-xl font-semibold text-slate-800">Managers Responsibilities</h2>
        </div>

        <div id="managers-purpose" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">1. Purpose</h2>
          <p className="text-sm text-slate-600">This section outlines the additional responsibilities of managers who have direct reports, in relation to the onboarding, off-boarding, and oversight of company-issued laptops. The aim is to ensure equipment is allocated, maintained, and returned efficiently, minimising disruptions and costs.</p>
        </div>

        <div id="managers-scope" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">2. Scope</h2>
          <p className="text-sm text-slate-600">This addendum applies to all Leaders, Heads Of, Directors and Team Leads (aka Managers) who are responsible for supervising employees, contractors or interns and managing their equipment lifecycle.</p>
        </div>

        <div id="onboarding" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">3. Onboarding Responsibilities</h2>
          <ul className="list-disc space-y-2 pl-5 text-sm text-slate-600">
        ...
        <div id="offboarding" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">4. Off-boarding Responsibilities</h2>
          <ul className="list-disc space-y-2 pl-5 text-sm text-slate-600">
        ...
        <div id="team-oversight" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">5. Team Equipment Oversight</h2>
          <ul className="list-disc space-y-2 pl-5 text-sm text-slate-600">
        ...
        <div id="laptop-costs" className="space-y-3">
          <h3 className="text-lg font-semibold text-slate-800">Laptop Costs - per device and Team</h3>
          <p className="text-sm text-slate-600">The following table shows the charges for laptops, and the use per department.</p>
        ...
        <div id="training-support" className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-800">6. Training and Support</h2>
          <ul className="list-disc space-y-2 pl-5 text-sm text-slate-600">
