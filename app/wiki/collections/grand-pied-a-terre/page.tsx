...
const properties = [
  { city: "London", bedrooms: 3, bathrooms: 2 },
  { city: "Rome", bedrooms: 3, bathrooms: 2 },
  { city: "Cannes", bedrooms: 3, bathrooms: 2 },
  { city: "Paris", bedrooms: 3, bathrooms: 2 },
  { city: "Barcelona", bedrooms: 3, bathrooms: 2 },
];

export default function GrandPiedATerreCollectionPage() {
  return (
    <div className="space-y-0">
      {/* Hero */}
      <section className="relative flex flex-col items-center justify-end overflow-hidden px-6 pb-12 pt-48 sm:pt-64">
        <Image
          src="/images/collection-grand_pied_a_terre.jpg"
          alt="Grand Pied à Terre collection"
          fill
