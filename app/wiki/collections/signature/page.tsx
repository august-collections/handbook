...
const properties = [
  { city: "Mallorca", bedrooms: 3, bathrooms: 3 },
  { city: "Tuscany", bedrooms: 3, bathrooms: 3 },
  { city: "Provence", bedrooms: 3, bathrooms: 2 },
  { city: "Algarve", bedrooms: 3, bathrooms: 3 },
];
  ...
  return (
    <div className="space-y-0">
      ...
      <section className="relative flex flex-col items-center justify-end overflow-hidden px-6 pb-12 pt-48 sm:pt-64">
        <Image
          src="/images/collection-signature.png"
