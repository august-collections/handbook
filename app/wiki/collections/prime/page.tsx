...
const properties = [
  { city: "Mallorca", bedrooms: 5, bathrooms: 5 },
  { city: "Tuscany", bedrooms: 5, bathrooms: 5 },
  { city: "Provence", bedrooms: 5, bathrooms: 4 },
  { city: "Algarve", bedrooms: 5, bathrooms: 5 },
];
  ...
  return (
    <div className="space-y-0">
      ...
      <section className="relative flex flex-col items-center justify-end overflow-hidden px-6 pb-12 pt-48 sm:pt-64">
        <Image
          src="/images/collection-prime.png"
