...
const properties = [
  { city: "London", bedrooms: 2, bathrooms: 1 },
  { city: "Rome", bedrooms: 2, bathrooms: 2 },
  { city: "Cannes", bedrooms: 2, bathrooms: 2 },
  { city: "Paris", bedrooms: 2, bathrooms: 1 },
  { city: "Barcelona", bedrooms: 2, bathrooms: 2 },
];

export default function PiedATerreCollectionPage() {
  return (
    <div className="space-y-0">
      {/* Hero */}
      <section className="relative flex flex-col items-center justify-end overflow-hidden px-6 pb-12 pt-48 sm:pt-64">
        <Image
          src="/images/collection-pied_a_terre.jpg"
          alt="Pied à Terre collection"
          fill
