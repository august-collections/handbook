...
export default function HrAndPeoplePage() {
  return (
    <div className="mt-10 space-y-8">
      <h1 className="text-3xl font-semibold text-slate-800">HR &amp; People</h1>
          ...
          <div className="grid gap-4 md:grid-cols-[120px_1fr] md:items-start">
            ...
            <div>
              ...
              <p className="mt-3 text-sm text-slate-600">
                &ldquo;Hello! I&apos;m Yasmin. I&apos;m here to support you with anything HR-related-payroll,
                benefits, wellbeing, and guidance on processes. Most queries go through your
                manager first, but you&apos;re always welcome to reach out directly.&rdquo;
              </p>
            </div>
          </div>
